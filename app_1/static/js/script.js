...
//        var marker1 = L.marker([{{profil.gps.x}}, {{profil.gps.y}}]).addTo(map);
//        marker1.bindPopup("<b>{{profil.prenom}} {{profil.nom}}</b><br>{{profil.nom_activite}}<br> {{profil.adresse_activite}}").openPopup();
//        {% endfor%}
